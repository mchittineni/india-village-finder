# Kerala Village Finder

Self-contained map app and dataset for **Kerala** (14 districts · 78 taluks ·
1,666 villages, LGD refresh of 20Sep2026).

> **Live:** https://mchittineni.github.io/india-village-finder/kerala/web/
...
data/
  kerala_villages.csv   flat export: one row per village
```
