...
window.VF_I18N = (function () {
  ...
  var DICT = {
    en: {
      ...
      loc_denied: "Location permission denied — search by name instead.",
      loc_unavailable: "Couldn’t get your location.",
      loc_outside: "You seem to be outside {state}.",
      help_title: "How to find your village",
      help_1: "Type your village name in the search box above.",
      help_2: "Or tap your district on the map, then your {tier}.",
      help_3: "Or press “Near me” to jump to where you are.",
      vd_tools: "What do you need?",
    ...
    te: {
      ...
      loc_denied: "స్థాన అనుమతి నిరాకరించబడింది — పేరుతో వెతకండి.",
      loc_unavailable: "మీ స్థానం దొరకలేదు.",
      loc_outside: "మీరు {state} వెలుపల ఉన్నట్లున్నారు.",
      help_title: "మీ గ్రామాన్ని ఎలా కనుగొనాలి",
      help_1: "పైన ఉన్న శోధన పెట్టెలో మీ గ్రామం పేరు టైప్ చేయండి.",
      help_2: "లేదా మ్యాప్‌లో మీ జిల్లాను, తర్వాత మీ {tier}ను నొక్కండి.",
      help_3: "లేదా మీరు ఉన్న చోటికి వెళ్లడానికి “నా సమీపంలో” నొక్కండి.",
      vd_tools: "మీకు ఏమి కావాలి?",
      directions: "దారి",
      share: "పంచుకోండి",
      link_copied: "లింక్ కాపీ అయింది",
      map_street: "మ్యాప్",
      map_satellite: "ఉపగ్రహ చిత్రం",
    ...
    hi: {
      ...
      loc_denied: "लोकेशन की अनुमति नहीं मिली — नाम से खोजें।",
      loc_unavailable: "आपकी लोकेशन नहीं मिल सकी।",
      loc_outside: "आप {state} से बाहर लगते हैं।",
      help_title: "अपना गाँव कैसे खोजें",
      help_1: "ऊपर खोज बॉक्स में अपने गाँव का नाम लिखें।",
      help_2: "या मानचित्र पर अपना ज़िला, फिर अपना {tier} दबाएँ।",
      help_3: "या आप जहाँ हैं वहाँ जाने के लिए “मेरे पास” दबाएँ।",
      vd_tools: "आपको क्या चाहिए?",
      directions: "रास्ता",
      share: "शेयर करें",
      link_copied: "लिंक कॉपी हो गया",
      map_street: "मानचित्र",
      map_satellite: "सैटेलाइट",
      ...
      pin_label: "पिन",
      lgd_label: "LGD",
      parcels_toggle: "भूमि खंड",
      parcels_zoom_hint: "भूमि खंड देखने के लिए ज़ूम इन करें।",
      show_parcels: "भूमि खंड दिखाएँ",
      parcels_none: "{name} के लिए कोई भूमि खंड नहीं मिला।",
      cadastre_loc_note: "भूमि खंड अभिलेखों से प्राप्त स्थान।",
      pl_search_ph: "सर्वे नंबर खोजें…",
      n_parcels: "{n} खंड",
      pl_empty: "कोई मेल खाता सर्वे नंबर नहीं।",
      parcel_title: "भूमि खंड",
      survey_no: "सर्वे नं.",
      parcel_area: "क्षेत्रफल: {n} m²",
      coordinates: "निर्देशांक:",
      open_in_maps: "मैप्स में खोलें",
      copy_coords: "कॉपी करें",
      coords_copied: "निर्देशांक कॉपी हो गए",
      cad_snapshot_note: "कडस्ट्रल स्नैपशॉट — लाइव भूमि रिकॉर्ड नहीं।",
    ...
    kn: {
      ...
      loc_denied: "ಸ್ಥಳ ಅನುಮತಿ ನಿರಾಕರಿಸಲಾಗಿದೆ — ಹೆಸರಿನಿಂದ ಹುಡುಕಿ.",
      loc_unavailable: "ನಿಮ್ಮ ಸ್ಥಳ ಸಿಗಲಿಲ್ಲ.",
      loc_outside: "ನೀವು {state} ಹೊರಗೆ ಇದ್ದಂತೆ ತೋರುತ್ತದೆ.",
      help_title: "ನಿಮ್ಮ ಗ್ರಾಮವನ್ನು ಹೇಗೆ ಹುಡುಕುವುದು",
      help_1: "ಮೇಲಿನ ಹುಡುಕಾಟ ಪೆಟ್ಟಿಗೆಯಲ್ಲಿ ನಿಮ್ಮ ಗ್ರಾಮದ ಹೆಸರನ್ನು ಟೈಪ್ ಮಾಡಿ.",
      help_2: "ಅಥವಾ ನಕ್ಷೆಯಲ್ಲಿ ನಿಮ್ಮ ಜಿಲ್ಲೆ, ನಂತರ ನಿಮ್ಮ {tier} ಒತ್ತಿ.",
      help_3: "ಅಥವಾ ನೀವಿರುವ ಸ್ಥಳಕ್ಕೆ ಹೋಗಲು “ನನ್ನ ಹತ್ತಿರ” ಒತ್ತಿ.",
      vd_tools: "ನಿಮಗೆ ಏನು ಬೇಕು?",
      directions: "ದಾರಿ",
      share: "ಹಂಚಿಕೊಳ್ಳಿ",
      link_copied: "ಲಿಂಕ್ ನಕಲಿಸಲಾಗಿದೆ",
      map_street: "ನಕ್ಷೆ",
      map_satellite: "ಉಪಗ್ರಹ ಚಿತ್ರ",
    ...
    ur: {
      ...
      loc_denied: "مقام کی اجازت نہیں ملی — نام سے تلاش کریں۔",
      loc_unavailable: "آپ کا مقام نہیں مل سکا۔",
      loc_outside: "لگتا ہے آپ {state} سے باہر ہیں۔",
      help_title: "اپنا گاؤں کیسے تلاش کریں",
      help_1: "اوپر تلاش کے خانے میں اپنے گاؤں کا نام لکھیں۔",
      help_2: "یا نقشے پر اپنا ضلع، پھر اپنا {tier} دبائیں۔",
      help_3: "یا جہاں آپ ہیں وہاں جانے کے لیے “میرے قریب” دبائیں۔",
      vd_tools: "آپ کو کیا چاہیے؟",
      directions: "راستہ",
      share: "شیئر کریں",
      link_copied: "لنک کاپی ہو گیا",
      map_street: "نقشہ",
      map_satellite: "سیٹلائٹ",
      ...
      pin_label: "پن",
      lgd_label: "LGD",
      parcels_toggle: "زمینی قطعات",
      parcels_zoom_hint: "زمینی قطعات دیکھنے کے لیے زوم اِن کریں۔",
      show_parcels: "زمینی قطعات دکھائیں",
      parcels_none: "{name} کے لیے کوئی زمینی قطعہ نہیں ملا۔",
      cadastre_loc_note: "زمینی قطعات کے ریکارڈ سے حاصل مقام۔",
      pl_search_ph: "سروے نمبر تلاش کریں…",
      n_parcels: "{n} قطعات",
      pl_empty: "کوئی مماثل سروے نمبر نہیں۔",
      parcel_title: "زمینی قطعہ",
      survey_no: "سروے نمبر",
      parcel_area: "رقبہ: {n} m²",
      coordinates: "کوآرڈینیٹس:",
      open_in_maps: "میپس میں کھولیں",
      copy_coords: "کاپی کریں",
      coords_copied: "کوآرڈینیٹس کاپی ہو گئے",
      cad_snapshot_note: "کڈسٹرل اسنیپ شاٹ — براہِ راست زمینی ریکارڈ نہیں۔",
    ...
    ta: {
      ...
      loc_denied: "இருப்பிட அனுமதி மறுக்கப்பட்டது — பெயரால் தேடுங்கள்.",
      loc_unavailable: "உங்கள் இருப்பிடத்தைப் பெற முடியவில்லை.",
      loc_outside: "நீங்கள் {state} மாநிலத்திற்கு வெளியே இருப்பது போல் தெரிகிறது.",
      help_title: "உங்கள் கிராமத்தை எப்படி கண்டுபிடிப்பது",
      help_1: "மேலே உள்ள தேடல் பெட்டியில் உங்கள் கிராமத்தின் பெயரைத் தட்டச்சு செய்யுங்கள்.",
      help_2: "அல்லது வரைபடத்தில் உங்கள் மாவட்டத்தை, பிறகு உங்கள் {tier}-ஐத் தட்டுங்கள்.",
      help_3: "அல்லது நீங்கள் இருக்கும் இடத்திற்குச் செல்ல “எனக்கு அருகில்” என்பதைத் தட்டுங்கள்.",
      vd_tools: "உங்களுக்கு என்ன வேண்டும்?",
      directions: "வழி",
      share: "பகிர்",
      link_copied: "இணைப்பு நகலெடுக்கப்பட்டது",
      map_street: "வரைபடம்",
      map_satellite: "செயற்கைக்கோள்",
      ...
      pin_label: "பின்",
      lgd_label: "LGD",
      parcels_toggle: "நிலத் துண்டுகள்",
      parcels_zoom_hint: "நிலத் துண்டுகளைக் காண ஜூம் இன் செய்யவும்.",
      show_parcels: "நிலத் துண்டுகளைக் காட்டு",
      parcels_none: "{name} க்கு நிலத் துண்டுகள் எதுவும் கிடைக்கவில்லை.",
      cadastre_loc_note: "நிலத் துண்டு பதிவுகளிலிருந்து பெறப்பட்ட இடம்.",
      pl_search_ph: "சர்வே எண்ணைத் தேடு…",
      n_parcels: "{n} துண்டுகள்",
      pl_empty: "பொருந்தும் சர்வே எண்கள் இல்லை.",
      parcel_title: "நிலத் துண்டு",
      survey_no: "சர்வே எண்",
      parcel_area: "பரப்பளவு: {n} m²",
      coordinates: "ஆயத்தொலைவுகள்:",
      open_in_maps: "மேப்ஸில் திற",
      copy_coords: "நகலெடு",
      coords_copied: "ஆயத்தொலைவுகள் நகலெடுக்கப்பட்டன",
      cad_snapshot_note: "நில அளவை ஸ்னாப்ஷாட் — நேரடி நில பதிவுகள் அல்ல.",
    ...
    ml: {
      ...
      near_me: "എന്റെ അടുത്ത്",
      locating: "നിങ്ങളുടെ സ്ഥാനം കണ്ടെത്തുന്നു…",
      loc_denied: "സ്ഥാന അനുമതി നിഷേധിച്ചു — പേര് ഉപയോഗിച്ച് തിരയുക.",
      loc_unavailable: "നിങ്ങളുടെ സ്ഥാനം ലഭിച്ചില്ല.",
      loc_outside: "നിങ്ങൾ {state}-ന് പുറത്താണെന്ന് തോന്നുന്നു.",
      help_title: "നിങ്ങളുടെ ഗ്രാമം എങ്ങനെ കണ്ടെത്താം",
      help_1: "മുകളിലെ തിരയൽ ബോക്സിൽ നിങ്ങളുടെ ഗ്രാമത്തിന്റെ പേര് ടൈപ്പ് ചെയ്യുക.",
      help_2: "അല്ലെങ്കിൽ മാപ്പിൽ നിങ്ങളുടെ ജില്ല, തുടർന്ന് നിങ്ങളുടെ {tier} ടാപ്പ് ചെയ്യുക.",
      help_3: "അല്ലെങ്കിൽ നിങ്ങൾ ഉള്ള സ്ഥലത്തേക്ക് പോകാൻ “എന്റെ അടുത്ത്” അമർത്തുക.",
      vd_tools: "നിങ്ങൾക്ക് എന്താണ് വേണ്ടത്?",
      directions: "വഴി",
      share: "പങ്കിടുക",
      link_copied: "ലിങ്ക് പകർത്തി",
      map_street: "മാപ്പ്",
      map_satellite: "ഉപഗ്രഹ ചിത്രം",
